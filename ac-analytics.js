...
require = (function e(b, g, d) {
    ...
    function (b, c, a) {
      (function () {
        ...
        function h(j, m) {
          function o(x, q) {
            var t = new Date();
            var u = new Date(t.setFullYear(t.getFullYear() + 2));
            var r = q || u;
            var w = j.c_r(x);
            if (w) {
              try {
          ...
          function p(v, q) {
            ...
            var u = j.c_r(v);
            if (u) {
              document.cookie = v + '=' + u + '; expires=' + t.toUTCString() + '; domain=apple.com; path=/'
            }
          }
          ...
          j.acAnalytics.dynamicObjectIdHandlerSafari = f;
          ...
          j.usePlugins = true;
          j.doPlugins = i;
          j.trackingServer = g.getTrackingServer();
          j.trackingServerSecure = g.getSecureTrackingServer();
          j.dc = g.getDataCenterId()
        }
        c.exports = h
      }) ()
    },
    ...
    function (b, c, a) {
      (function () {
        function d(g) {
          ...
          if (g.wd.location.hostname.match(/apple.com.cn/)) {
            p = 'cn'
          } else {
    ...
    function (b, c, a) {
      (function () {
        ...
        function j(q) {
          ...
          var n = '/(apple.com/retail/.+/map/|apple.com/buy/locator/|discussions.apple.com|discussionsjapan.apple.com)/g';
          if (!q.d.URL.match(n)) {
          ...
          if (!q.campaign) {
            ...
            if (q.campaign.match(/OAS-.+?-DOMAINS-/i)) {
              var u = 'http://' + q.campaign.replace(/OAS-.+?-DOMAINS-/i, '');
              q.referrer = (q.tcall) ? u : ''
            }
          }
          q.server = q.getQueryParam('alias');
          if (!q.server) {
            q.server = 'new approach ac-analytics'
          }
          q.campaign = q.getValOnce(q.campaign, 's_campaign', 0);
          q.prop6 = (!q.prop6 && q.getQueryParam('cp') && q.pageName) ? ('D="' + q.getQueryParam('cp').toLowerCase() + ': ' + q.pageName + '"')  : q.prop6;
          ...
          if ((!q.d.URL.match(/apple.com\/(\w{2}|befr|benl|chfr|chde|asia|lae)\/search\//) && !q.d.URL.match(/apple.com\/search\//)) && (q.d.referrer.match(/apple.com\/(\w{2}|befr|benl|chfr|chde|asia|lae)\/search\//) || q.d.referrer.match(/apple.com\/search\//))) {
            q.eVar2 = (q.d.referrer.match(/\/support\//)) ? 'acs: ' : ((q.d.referrer.match(/\/store\//) ? 'aos: ' : 'www: '));
            if (q.d.referrer.match(/apple.com\/(\w{2}|befr|benl|chfr|chde|asia|lae)\/search/)) {
              q.eVar2 += q.getQueryParam('q', '', q.d.referrer).replace(/\+/g, ' ');
              var p = q.d.referrer.match(/\/(\w{2}|befr|benl|chfr|chde|asia|lae)\//i);
              q.eVar2 += ' (' + p[0].replace(/\//g, '') + ')'
            } else {
              q.eVar2 += q.getQueryParam('q', '', q.d.referrer).replace(/\+/g, ' ') + ' (us)'
            }
          }
          ...
          if (document.referrer && document.referrer.indexOf('apple.com/startpage/') > - 1 && q.tcall) {
          ...
          if (q.prop32 || q.c_r('s_sid')) {
            var v = new Date();
            var r = v.getTime();
            v.setTime(r + 630720000);
            if (q.prop32) {
              q.c_w('s_psid', q.prop32, v)
            } else {
              q.c_w('s_psid', q.c_r('s_sid'), v)
            }
            q.c_w('s_sid', '', - 1)
          }
          ...
          var w = q.downloadLinkHandler();
          if (w) {
            if (w.match(/\.rss|\.xml/)) {
              q.eVar16 = q.prop16 = 'sign ups'
            } else {
              q.eVar11 = ((q.pageName && q.pageName !== '') ? q.pageName : '') + ' - ' + w.substring(w.lastIndexOf('/') + 1, w.length);
          ...
          q.linkLeaveQueryString = true;
          var o = q.linkHandler('itms.apple.com|itunes.apple.com', 'e');
          ...
          q.linkTrackVars = q.linkTrackVars.replace(new RegExp(' ', 'g'), '');
          function l() {
            var A = (q && q.c_r) ? q.c_r('s_vi')  : '';
            var z = (A) ? A.match(/^\s*\[CS\]v1\|(.+)\[CE\]\s*$/)  : null;
            if (z) {
              return z[1]
            }
          }
          q.prop49 = 'D=' + (l() || 's_vi');
          var x = q.getQueryParam('afid');
          if (x) {
            q.eVar10 = q.getValOnce(x, 's_afc')
          }
          q.prop4 = (q.prop4) ? q.prop4 : 'D=g';
          var y = q.c_r('rtsid') || q.c_r('rtsidInt') || null;
          if (y) {
            if (!q.events) {
              q.events = 'event37'
            } else {
              if (typeof q.events === 'string' && q.events.indexOf('event37') === - 1) {
                q.events += ',event37'
              }
            }
          }
  ...
  164: [
    function (b, c, a) {
      (function () {
        var h = b('@marcom/ac-object');
        var f = b('@marcom/s-code');
        ...
        function k(n) {
          ...
          if (!g || n.force === true) {
            var o = (n.bucket || '');
            g = window.s = f.init(i(o));
            var m = f.plugins.init(g);
            l(g, n)
          }
          return g
        }
 ...
 */
      (function (ae, w) {
          ...
          find: {
            ID: n ? function (ax, aw, av) {
             ...
             : function (ax, aw, av) {
              if (typeof aw.getElementById !== M && !av) {
                var au = aw.getElementById(ax);
                return au ? au.id === ax || typeof au.getAttributeNode !== M && au.getAttributeNode('id').value === ax ? [
                  au
                ] : w : [
                ]
              }
              ...
              if (av === 'nth') {
                ...
                return function (aC) {
                  ...
                  if (az && (az[am] !== au || !aC.sizset)) {
                    for (aA = az.firstChild;
                    aA; aA = aA.nextSibling) {
                      if (aA.nodeType === 1) {
                        aA.sizset = ++aB;
                        if (aA === aC) {
                          break
        ...
        function Y(au, aw, aA, aB, av, az) {
          var ax,
          ay = W.setFilters[aw.toLowerCase()];
          if (!ay) {
            ad.error(aw)
          }
          if (au || !(ax = av)) {
      ...
      function (c, b, d) {
        ...
        f._getDelegateFuncBindingIdx = function (r, o, m, k, t) {
          ...
          if (this._delegateFuncs[o] && this._delegateFuncs[o][r]) {
            var n,
            l,
            p = this._delegateFuncs[o][r].length;
            for (n = 0; n < p; n++) {
    ...
    307: [
      ...
      '@marcom/ac-analytics/controller/Touch': [
        function (b, c, a) {
          c.exports = b('FmX+Kz')
        },
        {
      ...
      '@marcom/ac-analytics/data-attr/helper': [
        function (b, c, a) {
          c.exports = b('DckvZc')
        },
        {
      ...
      '@marcom/ac-analytics/error-handler/ErrorHandler': [
        function (b, c, a) {
          c.exports = b('yoExqy')
        },
        {
      ...
      '@marcom/ac-analytics/factory/basicObserverSuite': [
        function (b, c, a) {
          c.exports = b('eT/lVE')
        },
        {
      ...
      '@marcom/ac-analytics/metricsTracker': [
        function (b, c, a) {
          c.exports = b('nHWlaR')
        },
        {
      ...
      '@marcom/ac-analytics/observer/Audio': [
        function (b, c, a) {
          c.exports = b('0uVCsT')
        },
        {
        ...
        function (f, c, j) {
          ...
          l._onInteraction = function (t) {
            ...
            if (!u.getAttribute('data-' + this.options.dataAttribute)) {
              r = a.ancestor(u, '[' + this.options.dataAttribute + ']');
              if (r) {
                u = r
              }
            }
      ...
      '@marcom/ac-analytics/observer/Click': [
        function (b, c, a) {
          c.exports = b('smIHK0')
        },
        {
      ...
      '@marcom/ac-analytics/observer/Event': [
        function (b, c, a) {
          c.exports = b('FP42yW')
        },
        {
      ...
      '@marcom/ac-analytics/observer/Exit': [
        function (b, c, a) {
          c.exports = b('G1nVnI')
        },
        {
      ...
      '@marcom/ac-analytics/observer/Gallery': [
        function (b, c, a) {
          c.exports = b('7OkBs0')
        },
        {
      ...
      '@marcom/ac-analytics/observer/Link': [
        function (b, c, a) {
          c.exports = b('csLHIR')
        },
        {
      ...
      '@marcom/ac-analytics/observer/Overlay': [
        function (b, c, a) {
          c.exports = b('ZDCq+L')
        },
        {
      ...
      '@marcom/ac-analytics/observer/Page': [
        function (b, c, a) {
          c.exports = b('2ltmNh')
        },
        {
      ...
      '@marcom/ac-analytics/observer/Section': [
        function (b, c, a) {
          c.exports = b('ft2q1p')
        },
        {
      ...
      '@marcom/ac-analytics/observer/Video': [
        function (b, c, a) {
          c.exports = b('EVr9gK')
        },
        {
      ...
      '@marcom/ac-analytics/onDocumentReady': [
        function (b, c, a) {
          c.exports = b('s+JdTz')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/plugins': [
        function (b, c, a) {
          c.exports = b('kyzDBL')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/helpers/DOM': [
        function (b, c, a) {
          c.exports = b('M8C1F0')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/helpers/formatter': [
        function (b, c, a) {
          c.exports = b('WZEdYN')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/helpers/metadata': [
        function (b, c, a) {
          c.exports = b('DHq73b')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/helpers/separator': [
        function (b, c, a) {
          c.exports = b('9JEe2W')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/helpers/setNavigationSrc': [
        function (b, c, a) {
          c.exports = b('fEHkLg')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/helpers/setOptions': [
        function (b, c, a) {
          c.exports = b('AtGs6E')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/helpers/templateVar': [
        function (b, c, a) {
          c.exports = b('2ZvpEb')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/sCode': [
        function (b, c, a) {
          c.exports = b('2v3JQJ')
        },
        {
      ...
      '2v3JQJ': [
        function (f, c, h) {
          var l;
          var m = f('../../error-handler/ErrorHandler');
          var g = f('@marcom/ac-object');
          var p = f('@marcom/ac-s-code');
          var d = f('../../metadata');
          ...
          l._initializePlugin = function (t, r) {
            ...
            this.initializeSCode(t, r)
          };
          l.initializeSCode = function (t, r) {
            r = r || {
            };
      ...
      '@marcom/ac-analytics/plugins/s-code/submit-methods/manual': [
        function (b, c, a) {
          c.exports = b('reNdTz')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/submit-methods/submitMethods': [
        function (b, c, a) {
          c.exports = b('1e2jY8')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/submit-methods/t': [
        function (b, c, a) {
          c.exports = b('Jo4tJj')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/submit-methods/tl': [
        function (b, c, a) {
          c.exports = b('0Vhqq3')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/component/audio': [
        function (b, c, a) {
          c.exports = b('g4AmU0')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/component/click': [
        function (b, c, a) {
          c.exports = b('hIhnjJ')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/component/event': [
        function (b, c, a) {
          c.exports = b('6NDW85')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/component/exit': [
        function (b, c, a) {
          c.exports = b('YjpnJy')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/component/gallery': [
        function (b, c, a) {
          c.exports = b('paaDxu')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/component/link': [
        function (b, c, a) {
          c.exports = b('iCOMu/')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/component/overlay': [
        function (b, c, a) {
          c.exports = b('94pkSs')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/component/page': [
        function (b, c, a) {
          c.exports = b('BagcUO')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/component/section': [
        function (b, c, a) {
          c.exports = b('+0a7ZJ')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/component/video': [
        function (b, c, a) {
          c.exports = b('5BgK4Z')
        },
        {
      ...
      '@marcom/ac-analytics/plugins/s-code/translator/translator': [
        function (b, c, a) {
          c.exports = b('LJ68Kt')
        },
        {
      ...
      '@marcom/ac-analytics/regexp/curlyBracePattern': [
        function (b, c, a) {
          c.exports = b('Fkknw/')
        },
        {
      ...
      '@marcom/ac-analytics/regexp/storeUrlPattern': [
        function (b, c, a) {
          c.exports = b('rjjbV7')
        },
        {
      ...
      '@marcom/ac-analytics/regexp/tokenPattern': [
        function (b, c, a) {
          c.exports = b('aNrbqj')
        },
        {
      ...
      '@marcom/ac-analytics/regions/Region': [
        function (b, c, a) {
          c.exports = b('DXveIM')
        },
        {
      ...
      '@marcom/ac-analytics/regions/regions': [
        function (b, c, a) {
          c.exports = b('DxeItO')
        },
        {
      ...
      '@marcom/ac-analytics/storageKey': [
        function (b, c, a) {
          c.exports = b('ntdzZF')
        },
        {
      ...
      '@marcom/ac-analytics/tokens/Registry': [
        function (b, c, a) {
          c.exports = b('scrVj8')
        },
        {
      ...
      '@marcom/ac-analytics/tokens/Replacer': [
        function (b, c, a) {
          c.exports = b('dJInuT')
        },
        {
      ...
      '@marcom/ac-analytics/translator/component/audio': [
        function (b, c, a) {
          c.exports = b('8lTacU')
        },
        {
      ...
      '@marcom/ac-analytics/translator/component/click': [
        function (b, c, a) {
          c.exports = b('JuqcqK')
        },
        {
      ...
      '@marcom/ac-analytics/translator/component/event': [
        function (b, c, a) {
          c.exports = b('kZao3w')
        },
        {
      ...
      '@marcom/ac-analytics/translator/component/exit': [
        function (b, c, a) {
          c.exports = b('yWnp5u')
        },
        {
      ...
      '@marcom/ac-analytics/translator/component/gallery': [
        function (b, c, a) {
          c.exports = b('P9nfNI')
        },
        {
      ...
      '@marcom/ac-analytics/translator/component/link': [
        function (b, c, a) {
          c.exports = b('L1gkGb')
        },
        {
      ...
      '@marcom/ac-analytics/translator/component/overlay': [
        function (b, c, a) {
          c.exports = b('vPF0EK')
        },
        {
      ...
      '@marcom/ac-analytics/translator/component/page': [
        function (b, c, a) {
          c.exports = b('NcRXMk')
        },
        {
      ...
      '@marcom/ac-analytics/translator/component/section': [
        function (b, c, a) {
          c.exports = b('chF+IX')
        },
        {
      ...
      '@marcom/ac-analytics/translator/component/video': [
        function (b, c, a) {
          c.exports = b('ighRR/')
        },
        {
      ...
      '@marcom/ac-analytics/translator/helpers/parseFromDataAttribute': [
        function (b, c, a) {
          c.exports = b('uohxOy')
        },
        {
      ...
      '@marcom/ac-analytics/translator/translator': [
        function (b, c, a) {
          c.exports = b('eq7uW9')
        },
        {
